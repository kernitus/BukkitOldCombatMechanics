...
dependencies {
    ...
    add("integrationTestImplementation", "io.kotest:kotest-runner-junit5-jvm:6.1.11")
    add("integrationTestImplementation", "io.kotest:kotest-assertions-core-jvm:6.1.11")
